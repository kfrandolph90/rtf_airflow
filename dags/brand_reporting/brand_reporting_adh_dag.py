...
WEEKLY_RF_QUERY = {'name':'RbyF_Consolidated_Weekly','query_id':'c8ebeeebf73e4250b932905ed0860f4d','adh_dest_table':'RTF_RbyF_Consolidated_Weekly'}
WEEKLY_RF_QUERY_RDID =  {'name':'RbyF_Consolidated_Weekly_RDID','query_id':'93656e5123994738b24285b5e4b98ac7','adh_dest_table':'RTF_RbyF_Consolidated_Weekly_RDID'}
SUMMARY_RF_QUERY = {'name':'RbyF_Consolidated_Summary','query_id':'6418a5a86cc14456bdd4930ef6faa4a9','adh_dest_table':'RTF_RbyF_Consolidated_Summary'}
SUMMARY_RF_QUERY_RDID = {'name':'RbyF_Consolidated_Summary_RDID','query_id':'1e17e9499ad14554b1e2546b57e8ac78','adh_dest_table':'RTF_RbyF_Consolidated_Summary_RDID'}
...
with dag:
    ...
    merge_wkly = BigQueryOperator(
                ...
                destination_dataset_table =  '{{ params.adh_project_id }}:{{ params.adh_dataset }}.'+ WEEKLY_RF_DEST_TABLE)
    ...
    merge_summary = BigQueryOperator(
                ...
                destination_dataset_table =  '{{ params.dest_project_id }}:{{ params.adh_ddest_datasettaset}}.' + SUMMARY_RF_TABLE)
